...
<WidgetItem percent={30} amount={false} value={1000} heading="Products" color="rgb(75 0 255)"/>
        </section>
        <section className="graphContainer">
           <div className="revenue-chart">
            <h2>Revenue & Transaction </h2>
            {/* graph here */}
            <BarChart data_1={[300,144,433,655,237,755,190]} data_2={[200,444,556,778,556,455,900]} title_1="Revenue" title_2="Transaction" bgColor_1="rgb(0,115,255)" bgColor_2="rgba(53,162,235,0.8)"/>
           </div>
           <div className="dashboard-categories">
          <h2>Inventory</h2>
         { data.categories.map((i)=> {
          return  <CategoryItem heading={i.heading} value={i.value} key={i.heading} color={`hsl(${i.value*4},${50}%,50%)`}/>
          })}
          <div></div>
           </div>
        </section>
        <section className="transaction-container">
          <div className="gender-chart">
            <h2>Gender Ratio</h2>
            {/* chart */}
            <DoughnutChart labels={["Male","Female"]}data={[12,19]} backgroundColor={["hsl(340,82%,56%)","rgba(53,162,235,0.8)"]} cutout={70}/>            <p><BiMaleFemale/></p>
