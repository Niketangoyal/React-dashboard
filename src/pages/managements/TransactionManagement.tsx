...
const img =
  "https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c2hvZXN8ZW58MHx8MHx8&w=1000&q=804";const orderItems:OrderItemType[]=[
  {
    name:"puma shoes",
    photo:img,
    _id:"aftdta",
    ...
    <main className="product-management">
      <section style={
        ...
        order.orderItems.map(i=>(
          <ProductCard name={i.name} photo={i.photo} quantity={i.quantity} price={i.price} _id={i._id} />)
        )
        }
      </section>
